...
<html>
	<head>
	<meta charset="utf-8" />
	<title> Setting Account - Personal Policies </title>
		...
		<div class="container">
				<div class="row">
					...
					<div class="col-md-12" style="margin: -700px 300px 0 400px">
							<label style="font-size: 30px;margin-left: 150px"><font face="Segoe UI Light" align="left" color="white">Personal Policies</font></label><br>
