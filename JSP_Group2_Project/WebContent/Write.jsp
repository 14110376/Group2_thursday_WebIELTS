...
<head>
	<meta charset="utf-8" />
	<title></title>
	<title> English skills - Writing </title>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="jumbotron" style="background-color: rgba(255,255,255,0.2); margin-top: -720px; width: 780px; margin-right:0px; height: 690px; float: right">
							<label style="font-size: 30px;margin-left: -20px"><font face="Segoe UI Light" align="left" color="white">Writing</font></label><br>
							<div style="width: 660px;height: 550px;background-color: rgba(0,0,0,0.3);overflow: auto; border: 1px solid #CCCCCC;margin: lem 0">
							<table class="table">
								<tr>
									<td>
									<center><img src="http://www.midwinter.com.au/wp-content/uploads/2013/05/application4.png" width="128" height="128"><br><a href="https://drive.google.com/file/d/0BzHb6IoHxxRVR2xuSUwxNUdSckk/view?usp=sharing" style="color: white">
										My IELTS Writing No.1
									</a></center>
									</td>
									<td>
									<center><img src="http://www.midwinter.com.au/wp-content/uploads/2013/05/application4.png" width="128" height="128"><br><a href="https://drive.google.com/file/d/0BzHb6IoHxxRVeXVtNjFMY1p6MkE/view?usp=sharing" style="color: white">
										My IELTS Writing No.2
									</a></center>
									</td>
								</tr>
							</table>
