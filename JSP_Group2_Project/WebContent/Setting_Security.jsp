...
<html>
	<head>
	<meta charset="utf-8" />
	<title> Setting Account - Sercurity </title>
		...
		<div class="container">
				<div class="row">
					...
					<div class="col-md-12" style="margin: -700px 300px 0 400px">
							<label style="font-size: 30px;margin-left: 150px"><font face="Segoe UI Light" align="left" color="white">Sercurity</font></label><br>
							<div style="width: 300px;height: 280px;margin: 0 150px 0 150px;border: 1px #CCCCCC;background-color: rgba(255,255,255,0.6)">
								<div class="col-md-12" style="width: 300px">
									<label style="margin-bottom: -10px;margin-top: 15px">Old Password</label>
									<input type="Password" class="form-control" placeholder="*****">
									<label style="margin-bottom: -10px;margin-top: 15px">New Password</label>
									<input type="Password" class="form-control" placeholder="***********">
									<label style="margin-bottom: -10px;margin-top: 15px">Re-enter New Password</label>
									<input type="Password" class="form-control" placeholder="***********">
