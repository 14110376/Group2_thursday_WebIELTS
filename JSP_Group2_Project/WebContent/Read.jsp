...
<head>
	<meta charset="utf-8" />
	<title></title>
	<title> English skills - Reading </title>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="jumbotron" style="background-color: rgba(255,255,255,0.2); margin-top: -720px; width: 780px; margin-right:0px; height: 690px; float: right">
							<label style="font-size: 30px;margin-left: -20px"><font face="Segoe UI Light" align="left" color="white">Reading</font></label><br>
							<div style="width: 660px;height: 550px;background-color: rgba(0,0,0,0.3);overflow: auto; border: 1px solid #CCCCCC;margin: lem 0">
								<table class="table">
									<tr>
										<td>
										<center><img src="https://cdn2.iconfinder.com/data/icons/social-media-8/512/note3.png" width="128" height="128"><br><a href="https://drive.google.com/file/d/0BzHb6IoHxxRVaGxQcER4YWdoakE/view?usp=sharing" style="color: white">
											My IELTS Reading No.1
										</a></center>
										</td>
										<td>
										<center><img src="https://cdn2.iconfinder.com/data/icons/social-media-8/512/note3.png" width="128" height="128"><br><a href="https://drive.google.com/file/d/0BzHb6IoHxxRVSkl6SFpISDFFYVk/view?usp=sharing" style="color: white">
											My IELTS Reading No.2
										</a></center>
										</td>
										<td>
										<center><img src="https://cdn2.iconfinder.com/data/icons/social-media-8/512/note3.png" width="128" height="128"><br><a href="https://drive.google.com/file/d/0BzHb6IoHxxRVRTVTMGhHVUtnWGM/view?usp=sharing" style="color: white">
											My IELTS Reading No.3
										</a></center>
										</td>
									</tr>
									<tr>
										<td>
										<center><img src="https://cdn2.iconfinder.com/data/icons/social-media-8/512/note3.png" width="128" height="128"><br><a href="https://drive.google.com/file/d/0BzHb6IoHxxRVY0hPcjR5X3g1eFE/view?usp=sharing" style="color: white">
											My IELTS Reading No.4
										</a></center>
										</td>
									</tr>
								</table>
