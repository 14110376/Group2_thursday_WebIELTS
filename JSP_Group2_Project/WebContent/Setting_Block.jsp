		...
		<div class="container">
				<div class="row">
					...
					<div class="col-md-12" style="margin: -700px 300px 0 400px">
							...
							<div style="width: 300px;height: 320px;margin: 0 150px 0 150px;border: 1px #CCCCCC;background-color: rgba(255,255,255,0.6)">
								<div class="col-md-12" style="width: 300px">
									...
									<a href="http://www.ieltsdrive.com.vn/" class="btn btn-success btn-lg" style="block;margin-top: 0px">Apply Changes</a>
								</div>
							</div>
					</div>
				</div>
