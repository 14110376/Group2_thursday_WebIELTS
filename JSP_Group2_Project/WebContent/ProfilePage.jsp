...
<head>
	<meta charset="utf-8" />
	<title> IELTS Drive - You Drive </title>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="jumbotron" style="background-color: rgba(255,255,255,0.2); margin-top: -720px; width: 780px; margin-right:0px; height: 550px; float: right">
							<a href="" class="btn btn-danger btn-sm" style="block;float: right">Upload</a>
							<label style="font-size: 30px;margin-left: -20px"><font face="Segoe UI Light" align="left" color="white">English Skills</font></label><br>
							<a href="Listen.html" style="float:left"><img src="G:\University\Web Programming\PROJECT\images\listen.png" width="300" height="199"/>
							<a href="Read.html" style="float:left; margin-left:-300px; margin-top: 210px"><img src="G:\University\Web Programming\PROJECT\images\read.png" width="300" height="199"/>
							<a href="Speak.html" style="float:right; margin-left:-300px; margin-top: 210px"><img src="G:\University\Web Programming\PROJECT\images\speak.png" width="300" height="199"/>
							<a href="Write.html" style="float:right"><img src="G:\University\Web Programming\PROJECT\images\write.png" width="300" height="199"/>
