				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="jumbotron" style="background-color: rgba(255,255,255,0.2); margin-top: -720px; width: 780px; margin-right:0px; height: 550px; float: right">
							...
							<a href="profile.html" style="float:left"><img src="images\user1.jpg" width="300" height="199"/>
							<button>Unfriend </button>
							<button>Send message</button>
							<button>Share document</button>
							<p style="color:white"> Name:Johnathandau Natass</p>
							<p style="color:white">Phone: 0934585245</p>
							<p style="color:white">Address: Khang Gia Apartment,Go Vap district</p>
							<p style="color:red">Highest IELTS grade <span style="color:white"> 780</span></p>
