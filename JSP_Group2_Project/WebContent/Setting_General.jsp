...
<html>
	<head>
	<meta charset="utf-8" />
	<title> Setting Account - General </title>
		...
		<div class="container">
				<div class="row">
					...
					<div class="col-md-12" style="margin: -700px 300px 0 400px">
							<label style="font-size: 30px;margin-left: 150px"><font face="Segoe UI Light" align="left" color="white">General</font></label><br>
							<div style="width: 300px;height: 480px;margin: 0 150px 0 150px;border: 1px #CCCCCC;background-color: rgba(255,255,255,0.6)">
								<div class="col-md-12" style="width: 300px">
									<label style="margin-bottom: -10px">Name</label>
									<input type="Name" class="form-control" placeholder="Benjamin">
									<input type="Name" class="form-control" placeholder="Franklin">
									<label style="margin-bottom: -10px;margin-top: 15px">User Name</label>
									<input type="UserName" class="form-control" placeholder="Benjamin Franklin">
									<label style="margin-bottom: -10px;margin-top: 15px">Email</label>
									<input type="Email" class="form-control" placeholder="BenFrank@gmail.com">
									<label style="margin-bottom: -10px;margin-top: 15px">Phone No.</label>
									<input type="Phone No." class="form-control" placeholder="0115487576">
									<img src="images/avatar.jpg" width="100" height="100" style="margin-top: 10px" />
									<div class="UpLoad">
									<button type="button" id="myButton" data-loading-text="Loading..." class="btn btn-primary" autocomplete="off" style="float: right;margin-top: -70px">Change Avatar
									</button>
									<script>
