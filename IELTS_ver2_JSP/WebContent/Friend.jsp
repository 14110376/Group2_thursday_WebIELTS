...
<head>
    ...
    <title>Friend - IELTS-Drive - Learn Eveywhere</title>
        ...
        <div id="page-wrapper" style="width: 905px">
            <div class="container-fluid">
                ...
                <div class="panel panel-default">
                	<div class="panel-heading" style="background-color: #F05F40;font-size: 30px" id="Account">Friend Information</div>
                    <div class="panel-body" style="border: 1px solid #F05F40">
                    	<div>
	                        ...
	                        <div style="margin-left: 40px; margin-top: -128px">
	                        	<img src="img/User.png" width="128" class="img-circle" height="128">
	                        	<h2 style="margin-left: 144px; margin-top: -80px;color: white"><strong>Name of Friend</strong></h2>
	                        </div>
	                        <button ></button>
                        </div>
                        <div style="margin-top: 60px">
                        	<p><strong>Full Name: </strong> Angela Cloudy</p>
                        	<p><strong>Describe: </strong>I'm a full-time student, a good girl, hard to study</p>
                        	<p><strong>Gender: </strong>Female</p>
                        	<p><strong>Phone No.: </strong>0909909xxx</p>
