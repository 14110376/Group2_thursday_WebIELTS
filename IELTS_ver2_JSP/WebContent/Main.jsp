        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" style="background-color: #F05F40">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="#Account" class="page-scroll"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Account</a>
                    </li>
                    <li>
                        <a href="#Drive" class="page-scroll"><i class="fa fa-fw fa-hdd-o" aria-hidden="true"></i> Your drive</a>
                    </li>
                    <li>
                        <a href="#Examinations" class="page-scroll"><i class="fa fa-fw fa-pencil-square-o" aria-hidden="true"></i> Examinations</a>
                    </li>
                    <li>
                        <a href="javascript:;" data-toggle="collapse" data-target="#demo"><i class="fa fa-fw fa-cog" aria-hidden="true"></i> Settings <i class="fa fa-fw fa-caret-down"></i></a>
                        <ul id="demo" class="collapse">
                            <li>
                                <a href="#Notification" class="page-scroll"><i class="fa fa-fw fa-envelope-o" aria-hidden="true"></i> Notification</a>
                            </li>
                            <li>
                                <a href="#BlockAccount" class="page-scroll"><i class="fa fa-fw fa-lock" aria-hidden="true"></i> Block Account</a>
                            </li>
                            <li>
                                <a href="#Personalization" class="page-scroll"><i class="fa fa-fw fa-user" aria-hidden="true"></i> Personalization</a>
                            </li>
                        </ul>
                    </li>
                </ul>
        ...
        <div id="page-wrapper" style="width: 905px">
            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-default"  style="height: 500px">
                    <div class="panel-heading" style="background-color: #F05F40;font-size: 30px" id="Account">Account Information</div>
                    <div class="panel-body">
                        <div>
                            <img src="img/User.png" class="img-circle" width="180" height="180">
                            <div>
                                <button class="btn btn-primary" style="margin-top: 10px;margin-left: 20px" data-toggle="modal" data-target="#ChangeAvatar">Change Avatar</button>
                            </div>
                            <div class="modal fade" id="ChangeAvatar" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  <div class="modal-header" style="background-color: #F05F40">
                                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                                    <h4 class="modal-title" id="myModalLabel" style="color: white">Upload Avatar</h4>
                                  </div>
                                  <div class="modal-body">
                                        ...
                                        <div class="container" style="width: 500px;margin-left: 100px;margin-top: -70px">
                                            ...
                                            <p>- This avatar is represent for your account and name, so you should choose what picture have your face in it</p>
                                            <p>- Allow to upload only *png, *jpg file</p>
                                        </div>
                                  </div>
                                  <div class="modal-footer">
                                    <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                            ...
                            <div>
                                <button class="btn btn-danger" style="margin-top: 10px;margin-left: 45px">Sign-out</button>
                            </div>
                        </div>
                        <div style="margin-left: 200px;margin-top: -270px">
                        <form role="form" id="SignupTable" action="target.php" style="width: 300px;margin-top: 10px">
                              <div class="form-group">
                                <label for="exampleInputUserName">User Name</label>
                                <input type="text" class="form-control" id="exampleInputUserName1" name="username" placeholder="Benjamin Franklin" readonly/>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputPassword">Password</label>
                                <input type="password" class="form-control" id="exampleInputPassword1" name="password"  placeholder="********" readonly/>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputEmail">Email address</label>
                                <input type="email" class="form-control" id="exampleInputEmail1" name="email" placeholder="BenFrank11996@gmail.com" readonly/>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputCountry">Your country</label>
                                <input type="text" class="form-control" id="exampleInputCountry1" name="country" placeholder="United State" readonly/>
                              </div>
                              <div class="form-group">
                                <label for="exampleInputCity">Your city</label>
                                <input type="text" class="form-control" id="exampleInputCity1" name="country" placeholder="Los Angeles" readonly/>
                              </div>
                              </form>
                        </div>
                        <div class="container" style="width: 300px;height: 200px;float: right;margin-top: -400px">
                            <h3>Tips</h3>
                            <p>1. Your account will be deleted if you do not sign in after 20 days</p>
                            <p>2. Change password every month make sure your account will be more protected</p>
                            <p>3. Do not give any information about your account for anybody, admin is nerver request this information</p>
                        </div>
                        <div style="float: right">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#InfoForm">Change Information</button>
                        </div>
                    </div>
                    <!--Model for button "Change Infomation-->
                    <div class="modal fade" id="InfoForm" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <div class="modal-header" style="background-color: #F05F40">
                            <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                            <h4 class="modal-title" id="myModalLabel" style="color: white">Change Information</h4>
                          </div>
                          <div class="modal-body">
                                <form role="form" id="SignupTable" action="target.php">
                                  <div class="form-group">
                                    <label for="exampleInputUserName">User Name</label>
                                    <input type="text" class="form-control" id="exampleInputUserName1" name="username" placeholder="Benjamin Franklin" />
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputPassword">Password</label>
                                  ...
                                  <div class="form-group">
                                    <label for="exampleInputEmail">Email address</label>
                                    <input type="email" class="form-control" id="exampleInputEmail1" name="email" placeholder="BenFrank11996@gmail.com" />
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputCountry">Your country</label>
                                    <input type="text" class="form-control" id="exampleInputCountry1" name="country" placeholder="United State" />
                                  </div>
                                  <div class="form-group">
                                    <label for="exampleInputCity">Your city</label>
                                    <input type="text" class="form-control" id="exampleInputCity1" name="country" placeholder="Los Angeles" />
                                  </div>
                                </form>
                          </div>
                          <div class="modal-footer">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading" style="background-color: #F05F40;font-size: 30px" id="Drive">Your Drive</div>
                    <div class="panel-body">
                        <!--Table 1-->
